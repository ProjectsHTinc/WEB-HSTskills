                ...
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-center flex-column flex-sm-row">
                      ...
                      <div class="wrapper text-center text-sm-left">
                          <a href="<?php echo base_url(); ?>home/get_all_provider_list"><p class="card-text mb-0">Total Staffs</p></a>
                        <div class="fluid-container">
                          <?php if(empty($res_staff_count)){
                          }else{
                            foreach($res_staff_count as $rows_staff_count){} ?>
                            <h3 class="card-title mb-0"><?php echo $rows_staff_count->staff_count; ?></h3>
                          <?php } ?>
                        </div>
                      </div>
                    </div>
